...
// 本机可检测工具优先（Codex / Claude / Kimi / Cursor）
...
export const aiTools: AITool[] = [
  ...
  { id: 'claude', name: 'Claude CLI', vendor: 'Anthropic', models: ['Claude Sonnet', 'Claude Opus'], subscriptionPrice: 20, apiInputPrice: 22, apiOutputPrice: 108, color: '#d97757', icon: '🟠' },
